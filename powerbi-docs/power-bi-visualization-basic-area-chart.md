...
面を選ぶには、その面内、または上部の折れ線に沿ってクリックします。  基本的な面グラフでは、レポート ページ上の他の視覚化がクロス フィルター処理されません。 ただし、面グラフは、レポート ページ上の他の視覚化によってトリガーされたクロス フィルター処理のターゲットになります。
