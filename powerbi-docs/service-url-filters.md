...
> [!NOTE]
> ピン留めされた[ライブ レポート ページ](service-dashboard-pin-live-tile-from-report.md) タイルでは、URL フィルターはまだサポートされていません。 
...
* ピン留めされた*ライブ レポート ページ* タイルでは、URL フィルターはまだサポートされていません。 
