...
顧客向けにダッシュボードとレポートを埋め込む場合は、そのダッシュボードとレポートをアプリ ワークスペース内に配置する必要があります。 アプリ ワークスペースの作成方法については、「[アプリ ワークスペースを作成する](../service-create-distribute-apps.md#create-an-app-workspace)」をご覧ください。

前述の "*マスター*" アカウントは、アプリ ワークスペースの管理者である必要があります。
