...
|データセット| 3.4.1| NA|
|日付| 1.2-37| https://cran.r-project.org/web/packages/date/index.html |
...
|gridExtra| マトリックス| glue|
|gridExtra (>= 2.0.0)| グラフィックス| reshape2|
...
|マトリックス| 1.2-10| https://cran.r-project.org/web/packages/Matrix/index.html |
|マトリックス| 1.2-10| https://cran.r-project.org/web/packages/Matrix/index.html |
|matrixcalc| coda| NA|
...
|rngtools (>= 1.2.3)| cluster| グラフィックス|
...
|スパム| 2.1-1| https://cran.r-project.org/web/packages/spam/index.html |
