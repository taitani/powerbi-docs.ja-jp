...
組織内のユーザーは、タイルや視覚エフェクトからデータをエクスポートできます。 [詳細情報](consumer/end-user-export-data.md)
...
アプリのプッシュの詳細については、[こちら](consumer/end-user-create-apps.md#how-to-install-an-app-automatically-for-end-users)をご覧ください。
