...
description: "Power BI のダッシュボードとレポートの利用状況の指標を表示する方法に関するドキュメント。 効果的なコンテンツを作成するために利用状況指標を測定します。"
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
> **注**: 利用状況の指標機能は、すべてのユーザーから無料と Pro の両方の利用状況の情報を取得します。 ただし、利用状況の指標データにアクセスし、実行するには、Pro ライセンスが必要です。
> 
> 

## <a name="about-the-usage-metrics-report"></a>利用状況の指標レポートについて
選択したワークスペースのダッシュボードまたはレポートについて、利用状況指標が提供されます。 特定のダッシュボードまたはレポートの利用状況指標データにアクセスするための必須要件:    
•    そのダッシュボードまたはレポートの編集のアクセス許可が与えられていること   
•    Pro ライセンスを所有していること
...
4. 結果を開くには、**[使用状況メトリックの表示]** を選択します。
    ...
    Power BI のダッシュボードやレポートを展開したり、保守管理したりするとき、利用状況指標は強力なツールとなります。 レポートの中で最も役に立つページはどれか、削除するべきページはどれかわかりますか。 レポート ページ別にスライスすると見つかります。ダッシュボードにモバイル レイアウトを構築するかどうか迷っていますか。 モバイル アプリと Web ブラウザーを比較したとき、どっちを利用してコンテンツにアクセスするケースが多いのか、利用状況指標レポートで確認できます。
5. 視覚効果をダッシュボードにピン留めすることもできます。監視が簡単になり、他のユーザーと共有できます。
   
   > **注**: 利用状況指標レポートからダッシュボードにタイルを固定すると、そのダッシュボードはアプリやコンテンツ パックに追加できません。
   > 
   > 
...
**[名前を付けて保存]** を使用して、利用状況の指標レポートをカスタマイズおよび共有できるフル機能の Power BI レポートに変換します。 個人用に設定されたコピーの作成後、基礎データセットに完全アクセスできます。特定のニーズに合わせ、利用状況指標レポートを完全カスタマイズできます。 Power BI Desktop を利用し、[Power BI サービス機能にライブ接続し](https://powerbi.microsoft.com/blog/connecting-to-datasets-in-the-power-bi-service-from-desktop)、利用状況指標レポートをカスタマイズすることもできます。
...
"名前を付けて保存" (カスタマイズ) を利用してコピーを作成すると、既に構築されていた読み取り専用のレポートがフル機能レポートに変換されます。  一見するとまったく同じに見えます。 しかしながら、編集ビューでレポートを開き、新しい視覚効果、フィルター、ページを追加し、既存の視覚効果を変更または削除するなどの操作が可能になります。 また、Power BI により、そのワークスペースのすべてのダッシュボードまたはすべてのレポートの利用状況指標を含むまったく新しいデータセットが作成されます。

> **ヒント**: ワークスペースのすべてのダッシュボードまたはすべてのレポートの利用状況指標にアクセスすることを Power BI に許可するには、[ページ レベル フィルターを削除](#remove-the-filter-to-see-all-the-usage-metrics-data-in-the-workspace)します。
> 
> 

1. 既に構築されていた利用状況指標レポートで、**[ファイル] > [名前を付けて保存]** の順に選択します。 利用状況の指標レポートがフル機能の Power BI レポートに変換されます。 これが*個人に合わせてカスタマイズされた*利用状況指標レポートです。
...
3. あるいは、新しいデータセットを開き、一からレポートを構築します。
   
    ![](media/service-usage-metrics/power-bi-new-dataset.png)
4. 新しいレポートが現在のワークスペースに保存され、**[最近]** コンテンツの一覧にも追加されます。
   
    ![](media/service-usage-metrics/power-bi-new-report.png)

### <a name="remove-the-filter-to-see-all-the-usage-metrics-data-in-the-workspace"></a>フィルターを削除し、ワークスペースのあらゆる利用状況指標データを表示する
