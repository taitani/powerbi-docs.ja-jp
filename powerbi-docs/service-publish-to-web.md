...
> 
> [!IMPORTANT]
> Power BI 管理者が、管理ポータルから、ユーザーが [Web に公開] を使用する機能を無効にすることができます。 **[テナント設定]** 内で、**[Web に公開]** を **[オフ]** にします。 これは、テナント全体への設定です。 詳しくは、「[Power BI 管理ポータル](service-admin-portal.md)」をご覧ください。
> 
> 
