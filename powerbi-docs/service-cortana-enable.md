...
3. Power BI サービスの右上隅の歯車アイコンを選び、**[設定]** を選びます。
   
    ![設定を選択する](media/service-cortana-enable/power-bi-cortana-settings.png)
4. **[データセット]** タブを選び、左の一覧から Cortana 用に有効にするデータセットを選びます。
5. **[Q&A と Cortana]** > **[Cortana がこのデータセットにアクセスすることを許可する]** > **[適用]** の順に選択します。
...
1. 実行している Windows 10 バージョンを確認します。 **[設定]**、**[システム]**、**[バージョン情報]** の順に開きます。
...
2. Cortana 用の職場または学校のアカウントを追加します。
