...
* [Power BI Q&A の概要](end-user-q-and-a.md)
...
1. Power BI の右上隅の歯車アイコン ![歯車アイコン](./media/end-user-q-and-a-direct-query/power-bi-cog.png) を選択し、**[設定]** を選択します。
   
   ![[設定] メニュー](./media/end-user-q-and-a-direct-query/powerbi-settings.png)
2. **[データセット]** を選択し、Q&A を有効にするデータセットを選択します
   
   ![[設定] メニューの [データセット] 画面](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-settings.png)
3. **[Q&A と Cortana]** を展開し、**[Turn on Q&A for this dataset (このデータセットで Q&A を有効にする)]** チェックボックスをオンにし、**[適用]** を選択します。
   
    ![展開された Q&A 領域](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-directquery.png)
