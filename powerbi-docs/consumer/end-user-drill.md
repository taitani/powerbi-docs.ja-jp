...
3. ドリルダウンがまだ有効になっていること ![有効になっているドリルダウン](./media/end-user-drill/power-bi-drill-icon2.png) を確認し、"*下を展開*" アイコン ![下を展開アイコン](./media/end-user-drill/power-bi-drill-icon6.png) を選びます。 ツリーマップに、市と州だけでなく郵便番号も表示されるようになります。 
