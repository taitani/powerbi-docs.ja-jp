...
データは、Azure Data Lake Storage Gen2 内の [**Common Data Model**](https://docs.microsoft.com/powerapps/common-data-model/overview) にエンティティとして格納されます。 データフローの作成と管理は、Power BI サービスのアプリ ワークスペースで行います。  
